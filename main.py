...
BOT_TOKEN = "6278691169:AAFnKPa_7jQxWiaJz_8MXFxeX95uEc8aoeM"
PAYMENT_CHANNEL = "@testing_xyz" #add payment channel here including the '@' sign
OWNER_ID = 1489381549 #write owner's user id here.. get it from @MissRose_Bot by /id
CHANNELS = ["@testing_xyzl"] #add channels to be checked here in the format - ["Channel 1", "Channel 2"] 
